...
const (
	// MemoryCacher represent Memory Cacher
	MemoryCacher TheCacherType = "memory"
	// FileCacher represent File Cacher
	FileCacher TheCacherType = "file"
	// RedisCacher represent Redis Cacher
	RedisCacher TheCacherType = "redis"
	// MemcacheCacher represent Memcache Cacher
	MemcacheCacher TheCacherType = "memcache"
	// PGCacher represent PostgreSQL Cacher
	PGCacher TheCacherType = "postgres"
	// MyCacher represent MySQL Cacher
	MyCacher TheCacherType = "mysql"
	// LedisCacher represent Ledis Cacher
	LedisCacher TheCacherType = "ledis"
	// NoDBCacher represent NoDB Cacher
	NoDBCacher TheCacherType = "nodb"
)
